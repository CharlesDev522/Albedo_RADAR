...
def test_legitimate_dethroned_at_ignores_voided_defeats():
    history = [
    ...
    dethroned = legitimate_dethroned_at(
        history,
        eval_runs=eval_runs,
        voided={85},
        reign_versions={84, 83},
        current_king_version=84,
    )
    assert 84 not in dethroned
